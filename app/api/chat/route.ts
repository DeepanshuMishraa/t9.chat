...
import { convertToModelMessages, LanguageModel, smoothStream, streamText } from 'ai';
import { headers } from 'next/headers'
import { getModelConfig, AIModel, ModelConfig } from "@/lib/models"
...
export async function POST(req: NextRequest) {
  try {
    ...
    const modelConfig: ModelConfig = getModelConfig(model as AIModel);
    ...
    const result = streamText({
      model: aiModel as unknown as LanguageModel,
