      ...
      <div className="flex flex-col h-screen bg-background">
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center space-y-4">
            ...
            <h2 className="text-xl font-semibold">Error Loading Conversation</h2>
            <p className="text-muted-foreground max-w-md">
              Sorry, we couldn't load this conversation. It may have been deleted or the link is invalid.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <Button variant="ghost" onClick={() => navigate("/chat")} className="text-muted-foreground hover:text-foreground">
